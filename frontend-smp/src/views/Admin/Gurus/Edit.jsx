...
export default function GurusEdit() {
  //title page
  document.title = "Edit Guru - Desa Digital";
  ...
  const fetchDataGuru = async () => {
    await Api.get(`/api/admin/gurus/${id}`, {
      //header
      headers: {
        //header Bearer + Token
  ...
  const updateGuru = async (e) => {
    ...
    //sending data
    await Api.post(`/api/admin/gurus/${id}`, formData, {
      //header
      headers: {
        //header Bearer + Token
        Authorization: `Bearer ${token}`,
            ...
            <div className="col-md-12">
              ...
              <div className="card border-0 rounded shadow-sm border-top-success">
                <div className="card-body">
                  <h6>
                    <i className="fa fa-pencil"></i> Edit Guru
                  </h6>
                  <hr />
