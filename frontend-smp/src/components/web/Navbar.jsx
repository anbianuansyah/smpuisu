          ...
          <div className="collapse navbar-collapse">
            <ul className="navbar-nav me-auto mb-2 mb-md-0">
              <li className="nav-item me-4">
                <i className="fa fa-envelope"></i> anbianuansyah@gmail.com
              </li>
              <li className="nav-item me-4">
                <i className="fa fa-phone"></i> +62 812-7553-1234
              </li>
            </ul>
            <div>
              IKUTI KAMI :
          ...
          <div className="row">
            <div className="col-md-9 d-none d-md-block d-lg-block">
              ...
              <div className="header-text">
                <h2 className="header-school">SMP UISU</h2>
                <hr />
                <div className="header-address">
                  Jln. Asahan Km. 4.5, Siantar Estate, Simalungun, Sumatera Utara, 21151
                </div>
              </div>
            </div>
            ...
            <ul className="navbar-nav me-auto mb-2 mb-md-0">
              ...
              <li className="nav-item ms-2">
                <Link
                  ...
                  to="/pages"
                >
                  <i className="fa fa-info-circle"></i> TENTANG SEKOLAH
                </Link>
              </li>
              ...
              <li className="nav-item ms-2">
                <Link
                  ...
                  to="/gurus"
                >
                  <i className="fa fa-user-circle"></i> GURU
                </Link>
              </li>
              ...
              <li className="nav-item ms-2">
                <Link
                  ...
                  to="/products"
                >
                  <i className="fa fa-shopping-bag"></i> PRODUK SEKOLAH
                </Link>
              </li>
